            ...
            <div className="my-10 grid grid-cols-2 gap-0 lg:grid-cols-5 sm:grid-cols-3 sm:gap-4">
                <ul>
                    <li className="mb-4 text-gray-300 text-md w-max" title="LinkedIn">
                        <a href="https://www.linkedin.com/in/vanessander-de-matos-147870225/" className="flex gap-2 justify-start items-center w-max ease-in-out duration-150 hover:text-teal-500">
                            <FaLinkedinIn />
                            <span className="text-sm font-initial">user/vanessander</span>
                        </a>
                    </li>
                    <li className="mb-4 text-gray-300 text-md w-max" title="Codepen">
                        <a href="" className="flex gap-2 justify-start items-center w-max ease-in-out duration-150 hover:text-teal-500">
                            <FaCodepen />
                            <span className="text-sm font-initial">/vanessander</span>
                        </a>
                    </li>
                </ul>
                <ul>
                    <li className="mb-4 text-gray-300 text-md w-max" title="GitHub">
                        <a href="https://github.com/vanessander" className="flex gap-2 justify-start items-center w-max ease-in-out duration-150 hover:text-teal-500">
                            <FaGithub />
                            <span className="text-sm font-initial">/vanessander</span>
                        </a>
                    </li>
                ...
                <div className="mt-10 sm:mt-0">
                    ...
                    <h3 className="text-md text-gray-400 sm:text-xl">vanessanderdematosmuinge@gmail.com</h3>
                </div>
            </div>
        </div>
    );
